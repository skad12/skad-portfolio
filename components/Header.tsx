...
import code1 from "../public/assets/code1.svg";
...
const navLinks = [
  ...
  {
    url: "https://skad-sanity-blog.vercel.app/",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
    ...
    <header className="md:flex">
      ...
      >
        <div className="flex items-center justify-between w-full h-full max-w-6xl mx-auto">
          <Link
            href="/"
            className="flex space-x-2 text-xl italic sm:text-2xl md:hover:text-marrsgreen dark:md:hover:text-carrigreen focus-visible:outline-marrsgreen dark:focus-visible:outline-carrigreen"
          >
            <Image src={code1} alt="" width={30} height={30} />
            <p>
              {" "}
              SK
              <span className="text-marrsgreen dark:text-carrigreen">AD</span>
            </p>
          </Link>
          <nav className="flex items-center">
            <div className="fixed z-30 w-11/12 transform -translate-x-1/2 rounded glassmorphism md:bg-transparent md:dark:bg-transparent md:backdrop-blur-none md:static bottom-4 left-1/2 md:left-auto md:transform-none bg-bglight dark:bg-carddark dark:text-textlight drop-shadow-lg md:drop-shadow-none">
              <ul className="flex items-center py-1 justify-evenly">
            ...
            <button
              ...
              aria-live="polite"
              className="flex items-center justify-center w-8 h-8 ml-1 rounded-lg link-outline"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                className="hidden transform scale-110 fill-textlight dark:inline-block md:dark:hover:fill-carrigreen"
              >
              ...
              <svg
                ...
                width="24"
                height="24"
                className="transform scale-90 dark:hidden md:hover:fill-marrsgreen "
              >
