            ...
            <div className="col-start-1 col-end-3 row-start-1 row-end-4 lg:row-end-7 lg:col-start-1 lg:col-end-3 flex justify-center items-center py-4 lg:mb-[20%]">
              <div className="relative w-72">
                <svg
                  ...
                  viewBox="0 0 96 21"
                  aria-hidden="true"
                  className="absolute hidden img-svg lg:block fill-marrsgreen dark:fill-carrigreen -top-14 -left-14"
                ...
                <div className="overflow-hidden rounded-md profile-picture md:overflow-visible md:shadow-2xl">
                  <Image
                    src={Profile}
                    width={1700}
                    height={1790}
                    priority
                    alt="skad profile picture"
                ...
                <svg
                  ...
                  viewBox="0 0 15 14"
                  aria-hidden="true"
                  className="absolute hidden img-svg lg:block fill-marrsgreen dark:fill-carrigreen bottom-8 -right-12"
                  xmlns="http://www.w3.org/2000/svg"
                >
...
const educationInfo = [
  ...
  {
    id: 2,
    title: "Certificate Course in Responsive Design",
    subTitle: "FreeCodeCamp.org | 2020 - 2021",
    list: [
  ...
  {
    id: 3,
    title: "B.Sc (Hons) in Hydrology",
    subTitle: "Federal University of Agriculture | 2013 ~ 2019",
    list: [],
  },
];
